    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {otherPractices && (
          <div className="bg-white border border-amber-200 rounded-xl p-6">
            ...
            <p className="text-xs text-amber-900/80 mb-3">
              Submitted under &quot;Other&quot; — listed here for transparency; RegenUS may verify separately.
            </p>
      ...
      <div className="bg-stone-50 border border-stone-200 rounded-xl p-6 text-center">
        <p className="text-sm text-stone-500 italic">
          Farm information is provided through the RegenUS onboarding process and may be subject to ongoing verification.
