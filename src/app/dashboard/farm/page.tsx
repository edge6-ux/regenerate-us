      ...
      <div className="space-y-6">
        <div className="bg-white border border-stone-200 rounded-xl p-6">
          ...
          <p className="text-xs text-stone-400 mt-4 sm:col-span-2">
            Restaurants list your farm as a supplier on dish submissions. To change your profile, contact Regenerate US.
          </p>
        </div>

        {farm.status === 'pending' && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-900">
            Your farm profile is awaiting Regenerate US review before it can appear in the public directory.
          </div>
        )}
      </div>
    </div>
